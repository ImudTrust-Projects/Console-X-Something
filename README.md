...
<p align="center">
	<a href="https://github.com/Seralyth/CXS/releases"><img src="https://img.shields.io/github/v/release/iiDk-the-actual/CXS?label=version&style=for-the-badge"></a>
	<a href="https://github.com/Seralyth/CXS/releases/latest"><img src="https://img.shields.io/github/downloads/iiDk-the-actual/CXS/latest/CXS.dll?style=for-the-badge"></a>
...
**CXS** is a network used to control your Gorilla Tag mods' users and other users on the network. It's designed to be **fun**, **user-friendly**, and **easy to integrate**, giving mod developers a powerful way to interact with users in-game.
...
# Installation 
1️⃣ **Download** the latest release 👉 [here](https://github.com/iiDk-the-actual/CXS/releases/latest)  
2️⃣ **Drag & Drop** `CXS.dll` into your **plugins** folder  
...
1. Drag all files from CXS (except Plugin.cs and PluginInfo.cs) into your project under a folder
3. Modify the configuration of CXS.cs and ServerData.cs in the "Configuration" regions
...
To execute CXS commands, you can use the `CXS.ExecuteCommand()` method with its given parameters. Here is the list of all working commands:
